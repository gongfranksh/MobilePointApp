...
import personal.wl.mobilepointapp.ui.adapter.MPAPosMachineListAdapter;
...
public class PosMachineSelectFragment extends BaseFragment implements WebServiceInterface, OnItemClickListener {

    private static final String TAG = PosMachineSelectFragment.class.getSimpleName();
...
//    private List<Branch> branches = new ArrayList<>();
    ...
    private List<PosMachine> posMachines = new ArrayList<>();


    private MPAPosMachineListAdapter mpaPosMachineListAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_posmachine, container, false);
        initView(view);
        initData();
        return view;
    }
    ...
    private void initView(View view) {
        ...
        mRvOperatorList = view.findViewById(R.id.posmachine_rv_list);
        mLinearLayoutManager = new LinearLayoutManager(getActivity());
        mRvOperatorList.setLayoutManager(mLinearLayoutManager);
        mContentLayout = view.findViewById(R.id.posmachine_fra_content_layout);
...
//        mEtSearch.addTextChangedListener(this);
    ...
    public void getfunctions() {
        ...
        callWebservices = new CallWebservices(this, AppConstant.Method_POS_MACHINE, paraList);
    ...
    public void onRecevicedResult(JSONArray jsonArray) {
        try {
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                posMachine.setBraid(rec.getString("braid"));
                posMachine.setPosno(rec.getString("posno"));
                posMachine.setPosdesc(rec.getString("posdesc"));
                posMachines.add(posMachine);

            }

            mpaPosMachineListAdapter = new MPAPosMachineListAdapter(getActivity(), posMachines);
            mRvOperatorList.setAdapter(mpaPosMachineListAdapter);
            mpaPosMachineListAdapter.setmClickListener(this);
            mpaPosMachineListAdapter.notifyDataSetChanged();
...
//    }
    ...
    public void onItemClick(View view, int postion) {
        ...
        String tmp_name = posMachines.get(postion).getPosno();
//        ToastUtil.show(getActivity(), "" + tmp_name);


        returnPosMachine(posMachines.get(postion));
