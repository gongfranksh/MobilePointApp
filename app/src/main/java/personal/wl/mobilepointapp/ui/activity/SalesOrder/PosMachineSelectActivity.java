...
import personal.wl.mobilepointapp.ui.fragment.Sales.BranchSelectFragment;
import personal.wl.mobilepointapp.ui.fragment.Sales.PosMachineSelectFragment;
...
public class PosMachineSelectActivity extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        getSupportFragmentManager().beginTransaction().replace(R.id.common_content_layout,new PosMachineSelectFragment()).commit();
    }
    ...
    private void initView() {
        ...
        mTitleBarTvTitle.setText("收银设备选择");
