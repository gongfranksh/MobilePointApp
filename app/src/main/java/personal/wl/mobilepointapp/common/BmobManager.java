...
import personal.wl.mobilepointapp.listener.IBmobListener;
...
import personal.wl.mobilepointapp.utils.DialogUtil;
...
//                order.setText(orderId);
            ...
            public void fail(int code, String reason) {
                ...
                if (code == -3) {
                    ...
                    MobilePointApplication.getAppContext().installBmobPayPlugin(AppConstant.PAY_PLUGIN_NAME);
                } else {
